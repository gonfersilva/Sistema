...
class BobineEditForm(ModelForm):
    CLIENTE = (
                ...
                ('PREMIUM HYGIENE', 'PREMIUM HYGIENE'), 
                ('DIATEC S.r.l', 'DIATEC S.r.l'),
                ('ENKA HIJYEN', 'ENKA HIJYEN'),
                ('Ontex Tuketim Urunleri San.ve TIC.A', 'Ontex Tuketim Urunleri San.ve TIC.A'),
                ('FAS SOCIETA´ PER AZIONI', 'FAS SOCIETA´ PER AZIONI'),
                ('NAPCO RIYADH PAPER PRODUCTS CO.', 'NAPCO RIYADH PAPER PRODUCTS CO.'),
                ...
                ('Napco Consumer Products Co.', 'Napco Consumer Products Co.'),
                ('National Paper Company Ltd.', 'National Paper Company Ltd.'),
