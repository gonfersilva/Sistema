...
class SearchPerfil(forms.Form):
    CORE = ((None, '---------'), ('3', '3"'), ('6', '6"'))
    PRODUTO = ((None, '---------'), ('NONWOVEN ELASTIC BANDS ELA-ACE 100 HE', 'NONWOVEN ELASTIC BANDS ELA-ACE 100 HE'), ('NONWOVEN ELASTIC BANDS ELA-ACE 100 HT', 'NONWOVEN ELASTIC BANDS ELA-ACE 100 HT'), ('NONWOVEN ELASTIC BANDS ELA-ACE 95 HE', 'NONWOVEN ELASTIC BANDS ELA-ACE 95 HE'), ('NONWOVEN ELASTIC BANDS ELA-SPUN 90 HE HL', 'NONWOVEN ELASTIC BANDS ELA-SPUN 90 HE HL'), ('NONWOVEN ELASTIC BANDS ELA-SPUN 95 HE HL', 'NONWOVEN ELASTIC BANDS ELA-SPUN 95 HE HL'), ('NONWOVEN ELASTIC BANDS ELA-SPUN 90 HT HL', 'NONWOVEN ELASTIC BANDS ELA-SPUN 90 HT HL'), ('NONWOVEN ELASTIC BANDS ELA-SPUN 95 HE HL',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             'NONWOVEN ELASTIC BANDS ELA-SPUN 95 HE HL'), ('NONWOVEN ELASTIC BANDS ELA-SPUN 100 HE HL', 'NONWOVEN ELASTIC BANDS ELA-SPUN 100 HE HL'), ('SIDE PANEL ELA-ACE 100 HE', 'SIDE PANEL ELA-ACE 100 HE'), ('NONWOVEN ELASTIC BANDS ELA-SPUN 100 HE BICO', 'NONWOVEN ELASTIC BANDS ELA-SPUN 100 HE BICO'), ('NONWOVEN ELASTIC BANDS ELA-ACE 105 HE', 'NONWOVEN ELASTIC BANDS ELA-ACE 105 HE'), ('NONWOVEN ELASTIC BANDS ELA-ACE 100 HE(D)', 'NONWOVEN ELASTIC BANDS ELA-ACE 100 HE(D)'), ('FRONTAL TAPE 48', 'FRONTAL TAPE 48'), ('CAR PROTECTION SHEET 57', 'CAR PROTECTION SHEET 57'), ('ELASTIC FILM', 'ELASTIC FILM'))
...
class BobineEditForm(ModelForm):
    CLIENTE = (
        ('Novatis', 'Novatis'), ('El Ghazou',
                                 'El Ghazou'), ('CEPRO', 'CEPRO'), ('SAH', 'SAH'),
        ('PAKTEN SAGLIK URUNLERI',
         'PAKTEN SAGLIK URUNLERI'), ('BB DISTRIBE SAS', 'BB DISTRIBE SAS'),
        ('Fine Hygienic Paper Co.', 'Fine Hygienic Paper Co.'), ('Ali Bardi Paper Mill Co.',
                                                                 'Ali Bardi Paper Mill Co.'), ('Hygienic Paper Company Ltd', 'Hygienic Paper Company Ltd'),
        ('ONTEX', 'ONTEX'), ('ABENA', 'ABENA'), ('NORSUDEX', 'NORSUDEX'), ('HALK HYGIENE',
                                                                           'HALK HYGIENE'), ('MEDIANE', 'MEDIANE'), ('PAUL HARTMANN AG', 'PAUL HARTMANN AG'),
        ('PANAI S.A.L.', 'PANAI S.A.L.'), ('NUNEX', 'NUNEX'), ('Sanita S.A.L.', 'Sanita S.A.L.'), ('PARMON', 'PARMON'), (
            'ARKAN', 'ARKAN'), ('MEGA DISPOSABLES S.A.', 'MEGA DISPOSABLES S.A.'), ('National Pride', 'National Pride'),
        ('Drylock Technologies SL', 'Drylock Technologies SL'), ('Cleopatra Tissue Products (PTY) Ltd',
                                                                 'Cleopatra Tissue Products (PTY) Ltd'), ('Celluloses de Brocéliande', 'Celluloses de Brocéliande'),
        ('Pozzani Disposables S.p.A.', 'Pozzani Disposables S.p.A.'), ('SANCELLA TUNISIE',
                                                                       'SANCELLA TUNISIE'), ('Faderco SPA', 'Faderco SPA'), ('MADAR GROUP', 'MADAR GROUP'),
        ('Sté SOFAS S.A.R.L.', 'Sté SOFAS S.A.R.L.'), ('PREMIUM HYGIENE',
                                                       'PREMIUM HYGIENE'), ('DIATEC S.r.l', 'DIATEC S.r.l'),
        ('ENKA HIJYEN', 'ENKA HIJYEN'), ('Ontex Tuketim Urunleri San.ve TIC.A', 'Ontex Tuketim Urunleri San.ve TIC.A'), (
            'FAS SOCIETA´ PER AZIONI', 'FAS SOCIETA´ PER AZIONI'), ('NAPCO RIYADH PAPER PRODUCTS CO.', 'NAPCO RIYADH PAPER PRODUCTS CO.'),
        ('Activ Medical Disposable', 'Activ Medical Disposable'), ('Drylock Technologies Ltd',
                                                                   'Drylock Technologies Ltd'), ('Drylock Technologies sro', 'Drylock Technologies sro'),
        ('NANO', 'NANO'), ('ClotheUp', 'ClotheUp'), ('Obviperiplo, Lda', 'Obviperiplo, Lda'), (
