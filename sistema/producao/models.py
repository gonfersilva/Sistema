...
class Palete(models.Model):
    ...
    peso_bruto = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name="Peso bruto")
    peso_palete = models.CharField(max_length=5, choices=PESOP, null=True, blank=True, verbose_name="Peso palete")
    peso_liquido = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name="Peso liqudo")
