...
urlpatterns = [
    ...
    url(r'^retrabalho/create/$', create_bobinagem_retrabalho, name='retrabalho_bobinagem'),
    ...
    url(r'^etiqueta/palete/(?P<pk>\d+)/$', etiqueta_palete_alternative, name='etiqueta_palete'),
