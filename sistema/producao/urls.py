...
urlpatterns = [
    ...
    url(r'^bobinagem/(?P<operation>.+)/(?P<pk>\d+)/', classificacao_bobines_all, name='classificacao_bobines_all'),
    url(r'^bobinagem/(?P<pk>\d+)/classificacao/', bobinagem_classificacao, name='bobinagem_classificacao'),
    url(r'^bobinagem/(?P<pk>\d+)/edit/', bobinagem_edit, name='bobinagem_edit'),
    url(r'^bobine/(?P<pk>\d+)/', update_bobine, name='bobineupdate'),
    url(r'^bobine/details/(?P<pk>\d+)/', bobine_details, name='bobine_details'),
    url(r'^bobine/details/edit/(?P<pk>\d+)/', bobine_edit, name='bobine_edit'),
    ...
    url(r'^retrabalho/filter/finalizar/(?P<pk>\d+)/$', bobinagem_retrabalho_finalizar, name='finalizar_retrabalho'),
    ...
    url(r'^encomenda/edit/(?P<pk>\d+)/', encomenda_edit, name='encomenda_edit'),
    ...
    url(r'^carga/carregar/(?P<pk>\d+)/$', carga_carregar, name='carga_carregar'),
    url(r'^carga/reabir/(?P<pk>\d+)/$', carga_reabir, name='carga_reabir'),
    url(r'^carga/carregar/add/(?P<pk_carga>\d+)/(?P<pk_palete>\d+)/$', add_palete_carga, name='add_palete_carga'),
    url(r'^carga/carregar/remove/(?P<pk_carga>\d+)/(?P<pk_palete>\d+)/$', remove_palete_carga, name='remove_palete_carga'),
    url(r'^carga/expedir/(?P<pk>\d+)/$', carga_expedir, name='carga_expedir'),
    url(r'^carga/finalizar/(?P<pk>\d+)/$', finalizar_carga, name='finalizar_carga'),
    ...
    url(r'^artigos/$', artigos_list, name='artigos_list'),
    url(r'^paletesemb/$', paletes_emb_list, name='paletes_emb_list'),
    url(r'^artigos/create/$', artigo_create, name='artigo_create'),
    url(r'^paletesemb/create/$', paletes_emb_create, name='paletes_emb_create'),
    url(r'^dadosbase/embalamento/$', embalamento_home, name='embalamento_home'),
    url(r'^filmes/$', filmes_list, name='filmes_list'),
    url(r'^filmes/create/$', filme_create, name='filme_create'),
    url(r'^cintas/$', cintas_list, name='cintas_list'),
    url(r'^cintas/create/$', cinta_create, name='cinta_create'),
    url(r'^cores/$', cores_list, name='cores_list'),
    url(r'^cores/create/$', core_create, name='core_create'),
    url(r'^mdfs/$', mdfs_list, name='mdfs_list'),
    url(r'^mdfs/create/$', mdf_create, name='mdf_create'),
    url(r'^cartao/$', cartao_list, name='cartao_list'),
    url(r'^cartao/create/$', cartao_create, name='cartao_create'),
    url(r'^transportes/$', transportes_list, name='transportes_list'),
    url(r'^transportes/create/$', transporte_create, name='transporte_create'),
    url(r'^transportes/artgiocliente/(?P<pk_artigo>\d+)/(?P<pk_cliente>\d+)/$', transportes_artigo_cliente, name='transportes_artigo_cliente'),
    url(r'^especificacoes/(?P<pk_artigo>\d+)/(?P<pk_cliente>\d+)/$', especificacoes_artigo_cliente, name='especificacoes_artigo_cliente'),
